...
Auditoinnin `product_name_match`-arvot kertovat käytetyn menetelmän: `unique_master_name`, `normalized_master_name`, `category_exact` tai `fuzzy_high_confidence`. Epäselvät ja löytymättömät nimet jäävät tarkistettaviksi.
