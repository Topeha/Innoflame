...
- Tuotenimen yleisiä sanapareja verrataan tuotemasterin tuotenimiin; pari hyväksytään vain, jos se johtaa yhteen tuoteryhmään.
...
Auditoinnin `product_name_match`-arvot kertovat käytetyn menetelmän: `unique_master_name`, `normalized_master_name`, `description_exact`, `category_exact`, `product_group_pair`, `product_group_word` tai `fuzzy_high_confidence`. Epäselvät ja löytymättömät nimet jäävät tarkistettaviksi.
