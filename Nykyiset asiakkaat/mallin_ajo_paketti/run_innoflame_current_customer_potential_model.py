...
def find_project_root() -> Path:
    ...
    raise FileNotFoundError(
        "Projektin lahdetiedostoja ei loytynyt. Aja skripti Innoflame-projektikansiosta "
        "tai pida mallin_ajo_paketti Nykyiset asiakkaat -kansion alla.\nTarkistetut kansiot:\n"
        + checked
    )


BASE_DIR = find_project_root()
RESULTS_DIR = BASE_DIR / "Nykyiset asiakkaat"
...
CRM_POTENTIALS_WORKCOPY_PATH = RESULTS_DIR / "CRM_potentials_workcopy.xlsx"

OUTPUT_DIR = RESULTS_DIR / "model_improvement_backtest_2025"
OUTPUT_XLSX = RESULTS_DIR / "model_improvement_backtest_2025.xlsx"
FALLBACK_OUTPUT_XLSX = RESULTS_DIR / "model_improvement_backtest_2025_calibrated_product_groups.xlsx"
NEXT_YEAR_OUTPUT_XLSX = RESULTS_DIR / "model_improvement_next_year_recent_weighted.xlsx"
